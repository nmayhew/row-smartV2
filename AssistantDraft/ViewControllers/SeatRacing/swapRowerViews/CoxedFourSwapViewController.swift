//
//  CoxedFourSwapViewController.swift
//  AssistantDraft
//
...
class CoxedFourSwapViewController: swapRowersParentViewController {
    ...
    override func viewDidLoad() {
        ...
        loadRowers()
        buttons = [bow,two,three,stroke,cox]
    ...
    func loadRowers() {
        ...
        cox.setTitle(rowersInBoat[4].rower!.name, for: .normal)
    }
    ...
    @IBAction func coxPressed(_ sender: Any) {
        tapped(sender: cox, rower: rowersInBoat[4].rower!, boat: boat!)
    }
}
