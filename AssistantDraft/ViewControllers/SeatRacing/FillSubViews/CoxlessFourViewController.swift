//
//  CoxlessFourViewController.swift
//  AssistantDraft
//
...
class CoxlessFourViewController: parentBoat {
    ...
    override func viewDidLoad() {
        ...
        setDelegates(textFields: [bow,two,three,stroke], boatLabel: boatName)
    ...
    @objc func sendRowers() {
        if(!sent) {
            let rowers = [bow.text!, two.text!, three.text!, stroke.text!]
    ...
    @objc func confirmRowers() {
        let textViewsArray: [UITextField] = [stroke, three, two, bow]
